...
namespace ReceitasApp.Views.Ingrediente
{
    ...
    public sealed partial class Excluir : Page
    {
        public Excluir()
        {
            ...
            comboBox.ItemsSource = Database.ListarUnidadeMedida();
        ...
        { 
            //UnidadeMedida um = (UnidadeMedida)comboBox.SelectedValue;

            UnidadeMedida um = comboBox.SelectedValue as UnidadeMedida;
            
            Database.ExcluirUnidadeMedida(um);
            //Frame.Navigate(typeof(Lista));

            //Database.ExcluirUnidadeMedida(comboBox.SelectedItem);
            //throw new NotImplementedException(); lvUnidadeMedida.ItemsSource = Database.ListarUnidadeMedida();
        }
